        ...
        return this.props.dataCollection.map((row) => {
            return <tr>
                {this.props.displayCheckBox ?
                    <td><input type="checkbox" className="checkbox" name="user-profile"/></td> : null}
            ...
            <tr>
                {
                    this.props.headers.map(
                        (header, i) => {
                            return <th>
                                { this.props.displayCheckBox && header.addCheckBox ?
                                    <input type="checkbox" className="checkbox pull-right" id="checkall"
                                           onChange={(e) => this.checkAll(e)}/> : null }
                                <span id={header.fieldName} className={header.sortingClass}
                                      onClick={this.onItemClick}>{header.label}</span>
                            </th>
                        }
                    )
                }
