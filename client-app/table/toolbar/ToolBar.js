...
// import Notifier from '../Notification.js'; TODO: Replace this notification
...
class ToolBar extends Component {
	...
	render () {
		...
		if (this.props.enableInsert) {
			insertBtn = (
				<button type='button'
					...
					<i className='glyphicon glyphicon-plus' /> { this.props.insertText }
				</button>
			)
		}
		...
		if (this.props.enableDelete) {
			deleteBtn = (
				<button type='button'
					...
					<i className='glyphicon glyphicon-trash' /> { this.props.deleteText }
				</button>
			)
		}
		...
		if (this.props.enableShowOnlySelected) {
			showSelectedOnlyBtn = (
				<button type='button'
					onClick={this.handleShowOnlyToggle.bind(this)}
