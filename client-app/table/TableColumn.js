...
class TableColumn extends Component {
	...
	shouldComponentUpdate (nextProps, nextState) {
		...
		let shouldUpdated = this.props.width !== nextProps.width || this.props.className !== nextProps.className || this.props.hidden !== nextProps.hidden || this.props.dataAlign !== nextProps.dataAlign ||
			typeof children !== typeof nextProps.children || ('' + this.props.onEdit).toString() !== ('' + nextProps.onEdit).toString()
	...
	render () {
		...
		return (
			<td style={tdStyle} title={columnTitle} className={className} {...opts}>
