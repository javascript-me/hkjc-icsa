...
// import Notifier from './Notification.js'; TODO: We need to create our own notification module, I don't like this dependency
...
class TableEditColumn extends Component {
	...
	render () {
		...
		if (customEditor) {
			...
			cellEditor = customEditor.getElement(this.handleCustomUpdate.bind(this), customEditorProps)
		} else {
